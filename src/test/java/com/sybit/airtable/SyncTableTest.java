...
public class SyncTableTest {
    ...
    public void findTest() {
        ...
        assertThat(table.find("1")).isEqualTo(record);
    }
    ...
    public void createTest() {
        ...
        assertThat(table.create(row)).isEqualTo(response);
    }
    ...
    public void updateTest() {
        ...
        assertThat(table.update("abc", row)).isEqualTo(response);
    }
